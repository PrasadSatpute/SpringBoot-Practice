...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(UserRepository userRepository, PasswordEncoder passwordEncoder) {
        ...
        System.out.println("4 DataInitializer Constructor Call - userRepository and passwordEncoder set - Not Created User");
    }


    @Override
    public void run(String... args) {
        System.out.println("10 DataInitializer - If Created Then     Set Admin User Predefine Data");
